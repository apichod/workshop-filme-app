...
export const CONTENT_DEFAULTS = {
  ...
  timeline_heading: "Comment s'inscrire",
  ...
  // Disponibilité de la salle de cours (cf. lib/availability.js) — remplace
  // l'ancien mécanisme de samedis fermés (workshop_closed_dates) : une date
  // n'est proposée à l'inscription que si la salle ET tous les formateurs
  // assignés à la formation sont disponibles ce jour-là (cf. isTopicDateAvailable).
  // Repli volontairement vide : IMPORTANT, tant que cette disponibilité n'a
  // pas été renseignée dans Préférences → Disponibilité salle de cours, AUCUNE
  // date n'est proposée à l'inscription (comportement "opt-in", comme pour la
  // disponibilité d'un formateur).
  classroom_availability_json: JSON.stringify({}),
  cgv_text: `1. Objet

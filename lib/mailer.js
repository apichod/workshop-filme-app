...
export async function sendAdminMagicLink(to, magicUrl) {
  const html = wrapper(
    'Accès admin — Workshops Filme',
    `
      <p style="font-size:14px;color:#8C8F90;margin:0 0 28px;line-height:1.6;">
        Cliquez sur le bouton ci-dessous pour accéder à l'administration des workshops.<br>
  ...
  await transporter.sendMail({
    from: `"Filme — Workshops" <${process.env.SMTP_USER}>`,
    to,
    subject: 'Votre lien de connexion admin — Workshops Filme',
    html,
  });
}

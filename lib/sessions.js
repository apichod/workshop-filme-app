...
// Dès qu'une session atteint le seuil de validation, toutes les autres
...
export async function cancelConflictingSessions(dateIso, keepSessionId, winningTopic, dateLabel) {

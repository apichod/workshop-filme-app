...
export default requireAuth(async function handler(req, res) {
  ...
  const { title, level, desc, fullDescription, program, price, duration, category, bonus, archived } = req.body || {};
  try {
    const topic = await updateTopic(id, { title, level, desc, fullDescription, program, price, duration, category, bonus, archived });
